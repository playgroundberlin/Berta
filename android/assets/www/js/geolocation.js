...
function log(message) {
  //document.getElementById("log").innerHTML = heading.headingAccuracy;
  document.getElementById("compass").innerHTML = message;
}
...
function trackHeading() {
  ...
  headID = navigator.compass.watchHeading(headingUpdate, function () { /* ignore error */ }, options);
...
function headingUpdate(heading) {
  ...
  compass.innerHTML = "Sound: " +soundDir +" Heading: " + (currentHeading+90) +"= " +arrow;
  log(heading.headingAccuracy);
}
...
var currentLat = document.getElementById("currentLat"),
    ...
    currentHead = document.getElementById("currentHead"),
    soundDistance = document.getElementById("soundDistance"),
    soundLat = document.getElementById("soundLat"),
    soundLon = document.getElementById("soundLon"),
    soundArtist = document.getElementById("soundArtist"),
    soundTitle = document.getElementById("soundTitle"),
    soundComment = document.getElementById("soundComment");


function updateDisplay() {
  currentLat.innerHTML = latitude;
  currentLon.innerHTML = longitude;
  currentAcc.innerHTML = accuracy;
  currentHead.innerHTML = currentHeading;
  soundDistance.innerHTML = currentDist;
  soundLat.innerHTML = route[next].x;
  soundLon.innerHTML = route[next].y;
  soundArtist.innerHTML = route[next].a;
  soundTitle.innerHTML = route[next].t;
  soundComment.innerHTML = route[next].c;
